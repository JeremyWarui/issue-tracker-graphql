...
import { ArrowLeft, User, Calendar, MessageSquare, Send, Edit } from "lucide-react"
...
export default function IssueDetailPage() {
    ...
    const [assigneeId, setAssigneeId] = useState<string>(issue?.assigneeId || "unassigned")
    ...
    return (
        <div className="min-h-screen bg-slate-100">
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="space-y-2">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <Badge variant={getStatusBadgeVariant(status)}>{status.replace("-", " ")}</Badge>
                                        </div>
            ...
            {/* Edit Modal */}
            <IssueModal open={isEditModalOpen} onOpenChange={setIsEditModalOpen} issue={issue} onSave={handleEditIssue} />
        </div>
    )
}
