...
export function Dashboard() {
    ...
    const stats = {
        ...
        inProgress: issues.filter((issue: Issue) => issue.status === "IN_PROGRESS").length,
                                ...
                                <CardContent className="py-4">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div
                                                className="text-lg font-bold text-muted-foreground">Open
                                            </div>
                                        </div>
                                        <div
                                            className="text-3xl font-bold">{stats.open}</div>
                                    </div>
                                </CardContent>
                            </Card>
                            <Card className="bg-white">
                            ...
                            <Card className="bg-white">
                                <CardContent className="py-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div
                                            className="text-3xl font-bold">{stats.closed}</div>
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
