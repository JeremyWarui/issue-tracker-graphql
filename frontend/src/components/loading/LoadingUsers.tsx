      ...
      <header className="border-b bg-white shadow-sm">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="">
              <div
                className="h-8 w-32 bg-gray-200 animate-pulse rounded mb-1"
                aria-hidden="true"
              />
              <div
                className="h-4 w-64 bg-gray-200 animate-pulse rounded"
                aria-hidden="true"
              />
            </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-white">
            <CardHeader className="flex flex-row justify-between">
              <div
                className="h-8 w-48 bg-gray-200 animate-pulse rounded"
                aria-hidden="true"
              />
              <div
          ...
          <Card className="bg-white">
            <CardHeader>
              <div
                className="h-8 w-40 bg-gray-200 animate-pulse rounded"
                aria-hidden="true"
              />
            </CardHeader>
            <CardContent>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-4">
                      <div
                        className="h-12 w-12 bg-gray-200 animate-pulse rounded-full"
                        aria-hidden="true"
                      />
                      <div className="space-y-2">
                        <div
                          className="h-5 w-24 bg-gray-200 animate-pulse rounded"
                          aria-hidden="true"
                        />
                        <div
