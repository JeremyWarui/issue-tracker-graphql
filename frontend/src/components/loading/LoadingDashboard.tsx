    ...
    >
      <header className="border-b bg-white shadow-sm">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="">
              <div
                className="h-8 w-48 bg-gray-200 animate-pulse rounded mb-1"
                aria-hidden="true"
              />
              <div
                className="h-4 w-80 bg-gray-200 animate-pulse rounded"
                aria-hidden="true"
              />
            </div>
      ...
      <main className="container mx-auto px-6 py-8">
        <div className="space-y-8">
          ...
          <div>
            <div
              className="h-6 w-40 bg-gray-200 animate-pulse rounded mb-4"
              aria-hidden="true"
            />
                ...
                <Card key={i} className="bg-white">
                  <CardContent className="py-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <div
                          className="h-7 w-7 bg-gray-200 animate-pulse rounded"
                          aria-hidden="true"
                        />
                        <div
          ...
          <div>
            <div
              className="h-6 w-32 bg-gray-200 animate-pulse rounded mb-4"
              aria-hidden="true"
            />
                    ...
                    <div key={i}>
                      <div className="flex items-center space-x-3 py-2">
                        ...
                        <div className="flex-1 min-w-0">
                          <div
                            className="h-5 w-64 bg-gray-200 animate-pulse rounded mb-1"
                            aria-hidden="true"
                          />
